...
class TestWorkflowStorage:
    ...
    def test_save_workflow_with_builder(self, mock_file, mock_yaml_dump):
        ...
        mock_builder.agent_specs = [
            {'vertex_id': 'agent1', 'agent_id': 'test_agent', 'instruction': 'Process data'}
        ]
        mock_builder.team_specs = []
        mock_builder.edge_specs = [
...
class TestWorkflowResolver:
    ...
    def test_resolve_workflow_with_config(self, mock_builder_class):
        ...
        workflow_data = {
            ...
            'config': {
                'agent_specs': [
                    {'vertex_id': 'v1', 'agent_id': 'agent1', 'instruction': 'Do task 1'},
                    {'vertex_id': 'v2', 'agent_id': 'agent2', 'instruction': 'Do task 2'}
                ],
                'team_specs': [
...
class TestWorkflowCLI:
    ...
    def test_create_manual_agent_vertices(self, mock_builder_class):
        ...
        result = self.runner.invoke(cli, [
            'create', 'manual_workflow',
            '--description', 'Manual workflow',
            '--version', '1.5.0',
            '--agent', 'vertex1:agent1:Process input',
            '--agent', 'vertex2:agent2:Generate output'
        ])
        ...
        mock_builder.add_agent_vertex.assert_any_call('vertex1', 'agent1', 'Process input')
        mock_builder.add_agent_vertex.assert_any_call('vertex2', 'agent2', 'Generate output')
    ...
    def test_run_workflow_invalid_json_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['run', 'test_workflow', '--input-data', 'invalid json{'])
    ...
    def test_test_workflow_invalid_json_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', 'invalid json{'])
    ...
    def test_test_workflow_empty_input_data(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', '""'])
    ...
    def test_run_workflow_null_input_data(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['run', 'test_workflow', '--input-data', 'null'])
    ...
    def test_test_workflow_null_input_data(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', 'null'])
    ...
    def test_run_workflow_large_json_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['run', 'test_workflow', '--input-data', large_json])
    ...
    def test_test_workflow_large_json_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', large_json])
    ...
    def test_run_workflow_nested_json_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['run', 'test_workflow', '--input-data', nested_json])
    ...
    def test_test_workflow_nested_json_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', nested_json])
    ...
    def test_run_workflow_array_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['run', 'test_workflow', '--input-data', array_json])
    ...
    def test_test_workflow_array_input(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', array_json])
    ...
    def test_run_workflow_special_characters(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['run', 'test_workflow', '--input-data', special_json])
    ...
    def test_test_workflow_special_characters(self, mock_storage):
        ...
        result = self.runner.invoke(cli, ['test', 'test_workflow', '--input-data', special_json])
