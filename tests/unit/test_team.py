...
class MockTeamBuilder:
    ...
    def build(self, agents=None):
        ...
        team.id = self.id
        team.name = self.name
        team.coordination_strategy = self.coordination_strategy.value if hasattr(self.coordination_strategy, 'value') else self.coordination_strategy
...
def mock_team_builder():
    with patch('engine_cli.commands.team.TeamBuilder', return_value=MockTeamBuilder()) as mock_builder:
        yield mock_builder

@pytest.fixture
def mock_agent_builder():
    with patch('engine_cli.commands.team.AgentBuilder', return_value=MockAgentBuilder(), create=True) as mock_builder:
        yield mock_builder
...
class TestTeamCLICommands:
    ...
    def test_create_team_basic(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
        """Test creating a basic team"""
        with patch('engine_cli.commands.team.success'), \
             patch('engine_cli.commands.team.table'), \
    ...
    def test_create_team_hierarchical(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
    ...
    def test_create_team_different_strategies(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
    ...
    def test_create_team_no_agents(self, cli_runner, mock_team_enums, mock_team_builder, mock_imports):
        ...
        with patch('engine_cli.commands.team.success'), \
            ...
            result = cli_runner.invoke(create, [
                'empty_team',
                '--strategy', 'collaborative',
                '--description', 'Team without agents'
            ])

            assert result.exit_code == 0

    def test_create_team_with_output_file(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports, temp_dir):
    ...
    def test_create_team_save_error(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
    ...
    def test_create_team_agent_creation_logic(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
        ...
        with patch('engine_cli.commands.team.success'), \
            ...
            result = cli_runner.invoke(create, [
                'agent_test_team',
                '--agents', 'agent1, agent2 , agent3',  # Test whitespace handling
                '--strategy', 'parallel'
            ])

            assert result.exit_code == 0

    def test_create_team_empty_agent_list(self, cli_runner, mock_team_enums, mock_team_builder, mock_imports):
        ...
        with patch('engine_cli.commands.team.success'), \
            ...
            result = cli_runner.invoke(create, [
                'empty_agents_team',
                '--agents', '',  # Empty agent list
                '--strategy', 'collaborative'
            ])

            assert result.exit_code == 0

    def test_create_team_with_leader(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
    ...
    def test_create_team_with_whitespace_in_agents(self, cli_runner, mock_team_enums, mock_team_builder, mock_agent_builder, mock_imports):
    ...
    def test_list_teams_error_handling(self, cli_runner):
        ...
        with patch('engine_cli.commands.team.team_storage', mock_error_storage), \
             patch('engine_cli.commands.team.error'):
