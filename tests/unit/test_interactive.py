...
class TestInteractiveCLI:
    ...
    def test_run_keyboard_interrupt(
        ...
        with patch.object(
            self.interactive.session, "prompt", side_effect=prompt_side_effect
        ):
            result = self.interactive.run()
...
class TestStartInteractive:
    ...
    @patch("engine_cli.interactive.InteractiveCLI")
    @patch("engine_cli.interactive.success")
    def test_start_interactive_keyboard_interrupt(
        self, mock_success, mock_interactive_class
    ):
